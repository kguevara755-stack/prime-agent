...
- Added a bundled `llm-council` skill that puts one question to several models over OpenRouter, has them peer-review each other's answers anonymously, and returns a chairman model's synthesis with the aggregate ranking.
